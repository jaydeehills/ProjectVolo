                ...
                return (
                  ...
                  >
                    <td colSpan={9} className="p-0">
                      ...
                      {/* Expanded reasoning */}
                      {isExpanded && (
                        <div className="px-4 pb-3 pt-1 bg-zinc-50 dark:bg-zinc-800/30 border-t border-zinc-100 dark:border-zinc-800/50">
                          ...
                          <div className="flex gap-4 mt-2 text-[11px] text-zinc-400 dark:text-zinc-600">
                            <span>
                              Market:{" "}
